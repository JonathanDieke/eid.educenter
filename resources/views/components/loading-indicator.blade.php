...
<div wire:loading.delay wire:target="nextStep, saveStep">
  <div style="display: flex; justify-content: center; align-items: center; background-color: rgba(0, 0, 0, 0.817); position: fixed; top: 0px; left: 0px; z-index: 9999; width: 100%; height: 100%; opacity: .65;">
