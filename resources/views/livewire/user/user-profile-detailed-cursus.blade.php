                            ...
                            <tbody>
                                @forelse ($userSchools as $user_school)
                                    <tr class="text-truncate">
                                        ...
                                        <td>{{ $user_school->formations->first()->type }}</td>
                                        <td>{{ $user_school->formations->first()->program_name }}</td>
                                        <td>{{ $user_school->formations->first()->status }}</td>
                                        <td>{{ $user_school->formations->first()->start_date . " - " . $user_school->formations->first()->end_date  }}</td>
                                        <td >
                                            <i class="feature-icon-sm ti-files mx-1"  data-placement="top" title="Ajouter des justificatifs" data-toggle="modal" data-target="#addFormationModal" wire:click=""></i>
                                            <i class="feature-icon-sm ti-eye mx-1"  data-placement="top" title="Consulter les justificatifs" data-toggle="modal" data-target="#showJustificatifsModal" wire:click=""></i>
                                            <i class="feature-icon-sm-danger ti-trash mx-1"  data-placement="top" title="Retirer la formation" wire:click="deleteUserSchoolFormation({{ $user_school->id }})"></i>
                                        </td>
                                    </tr>
                                    <tr>
                                @empty
                    ...
                    <form  class="row" autocomplete="off">
                        ...
                        <div class="form-row w-100">
                            <div class="form-group col-md-12">
                                <input type="text"  class="form-control form-control-sm" id="" placeholder="Etablissement" autocomplete="off" wire:model.lazy="user_school.name">
                            </div>
                        </div>
                        <div class="form-row  w-100">
                            <div class="form-group col-md-6">
                                <select class="custom-select" wire:model.lazy="user_school.country">
                                    <option selected>Choisissez un pays</option>
                                    <option value="pays1" >Pays 1</option>
                                    <option value="pays2" >Pays 2</option>
                                    <option value="pays3" >Pays 3</option>
                            ...
                            <div class="form-group col-md-6" >
                                <select class="custom-select" wire:model.lazy="user_school.state">
                                    <option selected>Choisissez un Etat </option>
                                    <option value="etat1">Etat 1</option>
                                    <option value="etat2" >Etat 2</option>
                                    <option value="etat3" >Etat 3</option>
                        ...
                        <div class="form-row w-100">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text"  class="form-control form-control-sm" placeholder="Date de début (jj/mm/aaaa)" autocomplete="off" wire:model.lazy="user_school_formation.start_date">
                            </div>
                            <div class="form-group col-md-6">
                                @error('user_school_formation.end_date') <span class="error font-italic text-danger">{{ $message }}</span> @enderror
                                <input type="text"  class="form-control form-control-sm" placeholder="Date de fin (jj/mm/aaaa)" autocomplete="off " wire:model.lazy="user_school_formation.end_date">
                            </div>
                        </div>
                        <div class="col-12">
